...
export default function Mentor() {
  ...
  return <div className="space-y-8"><PageHeader eyebrow="Guided learning" title="Build understanding, not just answers" description="Frame a topic or engineering decision and receive a structured AI explanation." />
